...
<h1 class="m-0 text-dark"><mark>Tambah penjualan</mark></h1>
@stop
@section('content')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('detail_penjualan.create') }}"><button type="submit" class="btn btn-danger"><i class="fas fa-save"> lanjut </i></button> </a>
