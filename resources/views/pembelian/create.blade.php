...
@error('total_beli') is-invalid @enderror" 
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('distributor')  is-invalid  @enderror"
                                ...
                                readonly>
                            <button class="btn  btn-warning" type="button" data-bs-toggle="modal" id="cari"
                                data-bs-target="#staticBackdrop1"><i class="fa fa-search"> Cari Data Distributor</i></i></button>
                        </div>
    ...
    btn-xs" onclick="pilih1('{{$distributor->id}}',  '{{$distributor->nama_distributor}}', '{{$distributor->alamat}}', '{{$distributor->notelepon}}')"  data-bs-dismiss="modal">
                                                ...
                                                <a href="{{ route('detail_pembelian.create') }}"><button type="submit" class="btn btn-danger"><i class="fas fa-save"> lanjut </i></button></a>
                                                    <a href="{{ route('pembelian.index') }}"
                                                        class="btn btn-warning"><i class="fa fa-times-circle"> Batal </i></button></a>
                                                </div>
                                    </div>
                                </div>
                            </div>
